...
const MenuSection: React.FC<MenuSectionProps> = ({ onAddToBasket }) => {
  ...
  const PremiumPlatterCard: React.FC<{ item: MenuItem; category: MenuCategory }> = ({ item, category }) => {
    ...
    return (
      <div className="relative bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50 rounded-2xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-500 border-4 border-gradient-to-r from-yellow-400 via-orange-500 to-red-500 hover:scale-105 transform">
        {/* Premium Badge */}
        <div className="absolute -top-4 -right-4 bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-4 py-2 rounded-full shadow-lg transform rotate-12">
        ...
        <div className="absolute bottom-4 right-8 text-orange-400 animate-pulse delay-1000">
        ...
        {/* Platter Contents */}
        {platterInfo && (
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 mb-6 border border-orange-200">
            ...
            <div className="grid grid-cols-1 gap-3">
              {platterInfo.items.map((platterItem, index) => (
                <div key={index} className="flex items-center gap-3 p-3 bg-gradient-to-r from-orange-100 to-red-100 rounded-lg">
        ...
        <div className="text-center">
          <AddToBasketButton
            ...
            className="text-xl px-8 py-4 bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 shadow-2xl"
          />
        </div>
      </div>
    );
    ...
    if (category.id === 'premium-platters') {
      return (
        <div className="mb-16">
          ...
          <div className="text-center mb-12 relative">
            <div className="absolute inset-0 bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 opacity-10 rounded-3xl"></div>
            <div className="relative py-8">
              <div className="flex items-center justify-center gap-3 mb-4">
                <Crown className="w-12 h-12 text-yellow-500" />
                <h3 className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-yellow-600 via-orange-600 to-red-600 bg-clip-text text-transparent">
                  {category.name}
                </h3>
                <Crown className="w-12 h-12 text-yellow-500" />
              </div>
              <div className="w-32 h-2 bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 mx-auto rounded-full mb-4"></div>
              <p className="text-gray-700 text-xl max-w-3xl mx-auto font-medium">
                {category.description}
              </p>
              
              {/* Attention-grabbing banner */}
              <div className="mt-6 bg-gradient-to-r from-red-500 to-orange-500 text-white px-8 py-4 rounded-2xl inline-block shadow-2xl animate-pulse">
                <div className="flex items-center gap-2 text-lg font-bold">
                  <Sparkles className="w-6 h-6" />
          ...
          {/* Special Call to Action for Platters */}
          <div className="mt-12 text-center">
            <div className="bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 rounded-3xl p-8 text-white shadow-2xl max-w-4xl mx-auto">
              <h4 className="text-2xl font-bold mb-4 flex items-center justify-center gap-2">
                <Users className="w-8 h-8" />
                Why Choose Our Premium Platters?
              </h4>
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div className="bg-white/20 rounded-xl p-4 backdrop-blur-sm">
                  <div className="text-3xl mb-2">💰</div>
                  <div className="font-bold">Great Value</div>
                  <div className="text-sm opacity-90">More food, better price</div>
                </div>
                <div className="bg-white/20 rounded-xl p-4 backdrop-blur-sm">
                  <div className="text-3xl mb-2">👥</div>
                  <div className="font-bold">Perfect Sharing</div>
                  <div className="text-sm opacity-90">Ideal for couples & friends</div>
                </div>
                <div className="bg-white/20 rounded-xl p-4 backdrop-blur-sm">
                  <div className="text-3xl mb-2">⭐</div>
                  <div className="font-bold">Variety</div>
                  <div className="text-sm opacity-90">Try multiple dishes at once</div>
                </div>
              </div>
            </div>
          </div>
