...
interface VegetableSideDishesSectionProps {
...
const VegetableSideDishesSection: React.FC<VegetableSideDishesSectionProps> = ({
  category,
  showVegetarianOnly,
  selectedSpiceLevel,
...
export default VegetableSideDishesSection;