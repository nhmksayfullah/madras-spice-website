...
interface VegetarianStartersSectionProps {
...
const VegetarianStartersSection: React.FC<VegetarianStartersSectionProps> = ({
  category,
  onAddToBasket,
  showVegetarianOnly,
  selectedSpiceLevel,
...
export default VegetarianStartersSection;