        ...
        <div className="flex justify-center items-center h-16 lg:h-20 relative">
          ...
          <div className="hidden md:flex items-center justify-center space-x-8">
            <button 
              ...
              className="text-black font-light text-sm hover:text-orange-600 transition-colors duration-200"
            >
              Home
            </button>
            <button 
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white/95 backdrop-blur-sm border-t border-gray-200 shadow-lg">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <button
                onClick={() => scrollToSection('hero')}
                className="block w-full text-left px-3 py-3 text-black font-light hover:text-orange-600 hover:bg-orange-50 rounded-md transition-colors duration-200"
              >
                Home
              </button>
              <button
