      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-amber-600 via-orange-600 to-red-600 bg-clip-text text-transparent">
              Traditional Dishes
            </h2>
            <ChefHat className="w-12 h-12 text-amber-600" />
          </div>
          <div className="w-32 h-2 bg-gradient-to-r from-amber-400 via-orange-500 to-red-500 mx-auto rounded-full mb-6"></div>
        ...
        <div className="mb-16">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {[
              ...
              return (
                <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-orange-200 hover:border-orange-400 transform hover:-translate-y-2">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border-2 border-orange-200">
            <div className="bg-gradient-to-r from-amber-600 to-orange-600 text-white p-6 text-center">
              <h3 className="text-2xl font-bold mb-2">🍛 Build Your Own Combination</h3>
              <p className="text-amber-100">Simple 2-step process - Choose protein, then choose sauce</p>
            </div>
            ...
            <div className="p-8">
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {proteins.map((protein) => (
                      <button
                        ...
                        className="p-4 border-2 border-gray-200 rounded-xl hover:border-orange-400 hover:bg-orange-50 transition-all duration-300 text-left group transform hover:-translate-y-1 hover:shadow-lg"
                      >
                        <div className="flex items-center justify-between mb-2">
                          <h5 className="font-bold text-gray-800 group-hover:text-orange-700">{protein.name}</h5>
              ...
              {showSauceSelection && (
                <div className="mb-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h4 className="text-xl font-bold text-gray-800">Choose Your Curry Sauce</h4>
              ...
              {selectedProtein && selectedSauce && (
                <div className="border-t-2 border-gray-200 pt-8">
                  <div className="bg-gradient-to-r from-green-50 to-orange-50 border-2 border-green-200 rounded-xl p-6 mb-6">
                  ...
                  <div className="text-center">
                    <button
                      ...
                      className="bg-gradient-to-r from-green-600 to-green-700 text-white px-8 py-4 rounded-xl font-bold text-xl hover:from-green-700 hover:to-green-800 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
                    >
          ...
          <div className="bg-gradient-to-r from-amber-600 via-orange-600 to-red-600 rounded-2xl p-8 lg:p-12 text-white">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center max-w-2xl mx-auto">
              <div className="bg-white/20 rounded-xl p-4 backdrop-blur-sm">
                ...
                <div className="font-bold">10 Proteins</div>
                <div className="text-sm opacity-90">Including vegetarian options</div>
              </div>
              <div className="bg-white/20 rounded-xl p-4 backdrop-blur-sm">
                <div className="text-3xl mb-2">🍛</div>
                <div className="font-bold">11 Curry Sauces</div>
                <div className="text-sm opacity-90">From mild to very hot</div>
              </div>
              <div className="bg-white/20 rounded-xl p-4 backdrop-blur-sm">
                <div className="text-3xl mb-2">👨‍🍳</div>
                <div className="font-bold">Fresh Made</div>
                <div className="text-sm opacity-90">Prepared to order</div>
              </div>
            </div>
          </div>
        </div>
